...
class MiniGridEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if action == self.actions.left:
            ...
            if self.agent_dir < 0:
                self.agent_dir += 4
            if cur_cell != None and cur_cell.type == 'food':
                reward[0] = .24
            if cur_cell != None and cur_cell.type == 'water':
                reward[1] = .12
            if cur_cell != None and cur_cell.type == 'home':
                reward[2] = .012
        ...
        # Move forward
            ...
            if fwd_cell != None and fwd_cell.type == 'goal':
                ...
                reward[3] = self._reward()
            if fwd_cell != None and fwd_cell.type == 'food':
                reward[0] = .24
            if fwd_cell != None and fwd_cell.type == 'water':
                reward[1] = .12
            if fwd_cell != None and fwd_cell.type == 'home':
                reward[2] = .012
